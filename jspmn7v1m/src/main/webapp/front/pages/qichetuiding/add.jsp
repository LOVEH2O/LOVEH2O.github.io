			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="tuikuanjine" type="text" name="tuikuanjine" id="tuikuanjine" disabled="disabled" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">退订原因：</label>
						<div class="layui-input-block">
							<input v-model="detail.tuidingyuanyin" type="text" :readonly="ro.tuidingyuanyin" name="tuidingyuanyin" id="tuidingyuanyin" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">退订时间：</label>
						<div class="layui-input-block">
							<input type="text" name="tuidingshijian" id="tuidingshijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div class="layui-form-item" pane>
		...
		<script>
			...
			var vue = new Vue({
                ...
                computed: {
                    tuikuanjine:{
                    get: function () {
                        return 1*this.detail.qichejiage*this.detail.shuliang
                    }
                    },
                },
				methods: {
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
                                ...
                                jquery('#tuidingshijian').val(getCurDate());
				laydate.render({
					elem: '#tuidingshijian'
				});
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='tuikuanjine'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.tuikuanjine = true;
                                                continue;
                                        }
                                        if(o=='tuidingyuanyin'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.tuidingyuanyin = true;
                                                continue;
                                        }
                                        if(o=='tuidingshijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.tuidingshijian = true;
                                                jquery('#tuidingshijian').val(obj[o]);
                                                continue;
                                        }
                                        if(o=='yonghuzhanghao'){
                                                vue.detail[o] = obj[o];
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('qichetuiding/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                                            // 提交数据
                                            http.requestJson('qichetuiding' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {

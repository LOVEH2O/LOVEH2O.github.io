			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.jinhuojia" type="text" :readonly="ro.jinhuojia" name="jinhuojia" id="jinhuojia" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="jinhuojine" type="text" name="jinhuojine" id="jinhuojine" disabled="disabled" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">供应商：</label>
						<div class="layui-input-block">
							<input v-model="detail.gongyingshang" type="text" :readonly="ro.gongyingshang" name="gongyingshang" id="gongyingshang" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		...
		<script>
			...
			var vue = new Vue({
                ...
                computed: {
                    jinhuojine:{
                    get: function () {
                        return 1*this.detail.jinhuojia*this.detail.shuliang
                    }
                    },
                },
				methods: {
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
                                ...
                                jquery('#jinhuoshijian').val(getCurDate());
				laydate.render({
					elem: '#jinhuoshijian'
				});
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='jinhuojine'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.jinhuojine = true;
                                                continue;
                                        }
                                        if(o=='gongyingshang'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.gongyingshang = true;
                                                continue;
                                        }
                                        if(o=='jinhuoshijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.jinhuoshijian = true;
                                                jquery('#jinhuoshijian').val(obj[o]);
                                                continue;
                                        }
					}
				}
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('jinchexinxi/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                                            // 提交数据
                                            http.requestJson('jinchexinxi' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {

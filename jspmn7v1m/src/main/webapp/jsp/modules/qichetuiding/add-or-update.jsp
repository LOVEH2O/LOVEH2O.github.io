						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>汽车价格</label>
										<input id="qichejiage" name="qichejiage" class="form-control" onchange="calculation()">
									</div>
									<div class="form-group col-md-6">
										<label>数量</label>
									...
									<div class="form-group col-md-6">
										<label>退款金额</label>
										<input name="tuikuanjine" id="tuikuanjine" name="tuikuanjine" class="form-control" placeholder="退款金额">
									</div>
									<div class="form-group col-md-6">
										<label>退订原因</label>
										<input name="tuidingyuanyin" id="tuidingyuanyin" name="tuidingyuanyin" class="form-control" placeholder="退订原因">
									</div>
									<div class="form-group col-md-6">
										<label>退订时间</label>
										<div id="tuidingshijianDate" class="input-append date form_datetime">
											<input id="tuidingshijian-input" name="tuidingshijian" size="15" type="text" readonly>
	...
	<script>
				...
				if(crossrefid && crossuserid) {
					...
					http("qichetuiding/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("qichetuiding/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("qichetuiding/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#tuidingshijian-input").val(getCurDate());
			$("#tuidingshijianDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function calculation(){
			...
			var y = 0;
			var flag = 0;
			if($("#qichejiage").val() != null && $("#qichejiage").val() != ""){
				if(x == 0 && flag < 2){
					x = (x+1) * parseFloat($("#qichejiage").val());
					flag++;
				}else{
					x = x * parseFloat($("#qichejiage").val());
					flag++;
				}
			}
		...
		function dataBind(){
			...
			$("#tuikuanjine").val(ruleForm.tuikuanjine);	
			$("#tuidingyuanyin").val(ruleForm.tuidingyuanyin);	
			$("#tuidingshijian-input").val(ruleForm.tuidingshijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.tuikuanjine != null && res.data.tuikuanjine != ''){

						$("#tuikuanjine").val(res.data.tuikuanjine);
						$("#tuikuanjine").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.tuidingyuanyin != null && res.data.tuidingyuanyin != ''){

						$("#tuidingyuanyin").val(res.data.tuidingyuanyin);
						$("#tuidingyuanyin").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.tuidingshijian != null && res.data.tuidingshijian != ''){

						$("#tuidingshijian-input").val(res.data.tuidingshijian);
						$('#tuidingshijianFileName').val(res.data.tuidingshijian)
					}

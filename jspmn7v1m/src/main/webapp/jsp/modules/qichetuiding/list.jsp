...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">汽车退订管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>汽车退订列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">汽车退订列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('tuikuanjine')">退款金额<i id="tuikuanjineIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('tuidingyuanyin')">退订原因<i id="tuidingyuanyinIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('tuidingshijian')">退订时间<i id="tuidingshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var tuikuanjineCell  = document.createElement('td');

						 tuikuanjineCell.innerHTML = item.tuikuanjine;

			row.appendChild(tuikuanjineCell);
			var tuidingyuanyinCell  = document.createElement('td');

						 tuidingyuanyinCell.innerHTML = item.tuidingyuanyin;

			row.appendChild(tuidingyuanyinCell);
			var tuidingshijianCell  = document.createElement('td');

						  tuidingshijianCell.innerHTML = item.tuidingshijian;


			row.appendChild(tuidingshijianCell);
		...
		function sh(){
			...
			httpJson("qichetuiding/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("qichetuiding/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"qichetuiding");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"qichetuiding");

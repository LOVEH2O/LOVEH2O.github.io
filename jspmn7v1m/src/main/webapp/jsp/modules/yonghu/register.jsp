...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210811/5f9f8baf876d4023971df2c900b71701.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	#login-wrapper h1 {
		...
		border-style: solid;
		border-color: rgba(0,0,0,.3);
		background-color: rgba(98, 171, 0, 1);
